  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar navbar-dark" style="background-color: #74a0bd;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('xu-Ly-Dang-Xuat')}}"onclick="return logout()" role="button">
