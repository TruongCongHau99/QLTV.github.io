...
<body style="background-color:rgb(164, 150, 241);">
  ...
  <nav class=" navbar navbar-expand navbar navbar-dark bg-primary">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link"><b>TRANG CHỦ</b></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <!-- /.navbar -->
    ...
    {{-- <h1 class="text-center mt-4 mb-4 "style="color:#0033CC;font-size:400%;">QUẢN LÝ THƯ VIỆN</h1> --}}
